...
Each ADR captures a decision made during the project's design with its context, alternatives considered, and consequences.

| # | Title | Status |
|---|---|---|
| [0001](ADR-0001-kmp-compose-multiplatform.md) | Kotlin Multiplatform with Compose Multiplatform | Accepted |
